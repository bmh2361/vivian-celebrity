        ...
        {open && (
          <div className="md:hidden border-t border-[#e8e8e8] bg-white/95 backdrop-blur-sm">
            <div className="px-6 py-4 grid grid-cols-1 gap-1 text-base">
              ...
              <a href="/pages/makeup.html" onClick={() => setOpen(false)} className="py-3 hover:text-[#CFAF6B] transition-colors">
                {t.nav.makeup}
              </a>
              <a href="/pages/photography.html" onClick={() => setOpen(false)} className="py-3 hover:text-[#CFAF6B] transition-colors">
                {t.nav.photography}
              </a>
              <a href="/pages/bespoke.html" onClick={() => setOpen(false)} className="py-3 hover:text-[#CFAF6B] transition-colors">
                {t.nav.bespoke}
              </a>
              <a href="/pages/portfolio.html" onClick={() => setOpen(false)} className="py-3 hover:text-[#CFAF6B] transition-colors">
                {t.nav.portfolio}
              </a>
              <a href="/pages/about.html" onClick={() => setOpen(false)} className="py-3 hover:text-[#CFAF6B] transition-colors">
                {t.nav.about}
              </a>
              <a href="/pages/contact.html" onClick={() => setOpen(false)} className="py-3 hover:text-[#CFAF6B] transition-colors">
                {t.nav.contact}
              </a>
              <a
