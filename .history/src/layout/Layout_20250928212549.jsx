      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-[#e8e8e8]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {pageKey !== 'contact' && (
              <a href="/pages/contact.html" className="hidden md:inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-white bg-[#111] hover:bg黑色 transition-colors">
        ...
        {open && (
          <div className="md:hidden border-t border-[#e8e8e8] bg-white/95 backdrop-blur-sm">
            <div className="px-6 py-4 grid grid-cols-1 gap-3 text-sm">
              ...
              <a href="/pages/contact.html" onClick={() => setOpen(false)} className="inline-flex items-center justify-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-white bg-[#111] hover:bg黑色 transition-colors"><Icon name="CalendarDays" />{t.cta}</a>
            </div>
          </div>
        )}
      </header>
