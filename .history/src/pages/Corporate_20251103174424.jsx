...
export default function Corporate() {
  ...
  const LogoCell = ({ index }) => {
    ...
    return (
      <div className="h-36 md:h-40 px-6 md:px-8 py-5 md:py-6 rounded-lg border border-[#eee] bg-white relative overflow-hidden grid place-items-center shadow-[0_4px_16px_rgba(0,0,0,0.06)]">
        <img
          src={src}
          alt={`Partner Logo ${index}`}
          className="block max-h-[90%] max-w-[90%] object-contain z-[1]"
          loading="lazy"
