...
export default function Home() {
	...
	const copy = {
		zh: {
			...
			ctaConsult: '预约咨询',
			ctaPortfolio: '查看作品集',
			founderRole: '造型总监 · VIVIAN CELEBRITY 创始人',
			founderBio:
		...
		en: {
			...
			founderRole: 'Styling Director · VIVIAN CELEBRITY Founder',
			founderBio:
					...
					<motion.div {...fade(0.15)} className="relative">
						<div className="relative mx-auto w-[86%] md:w-[88%] aspect-[4/3] bg-white rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] overflow-hidden transform rotate-2">
							...
							<div className="pointer-events-none absolute inset-x-0 bottom-0 h-16" aria-hidden
								 style={{
									 background: 'linear-gradient(to bottom, rgba(207,175,107,0) 0%, rgba(207,175,107,0.18) 60%, rgba(207,175,107,0.28) 100%)'
								 }}
							/>
						</div>
						{/* 画框外的环境投影，稍淡 */}
