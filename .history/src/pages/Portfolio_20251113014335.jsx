...
function MarqueeColumn({ images, reverse }) {
	// 慢速循环：复制一次形成无缝带；速度调至 72s 更平缓
	const cls = `flex flex-col gap-4 marquee-runner marquee-allow-motion`;
		return (
			<div className="overflow-hidden rounded-xl border border-[#eee] pt-0 px-2 pb-2 bg-white/70" /* 去掉顶部 fade 与额外留白，保证最上方即为图片 */>
			<div
				className={cls}
				style={{
					['--gap']: '1rem',
					animationName: 'marquee-y',
					animationDuration: 'var(--dur, 72s)', // 放慢速度
