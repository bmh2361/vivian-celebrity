	...
	return (
		<div className="overflow-hidden rounded-xl border border-[#eee] pt-0 px-2 pb-2 bg-white/70">
			<div
				...
				style={{
					['--gap']: '1rem',
					animationName: 'marquee-tight',
					animationDuration: 'var(--dur, 80s)', // 略快于 90 保持流动
			...
			>
				{doubled.map((src, i) => (
					<img
						...
						decoding="async"
						onError={onErr}
						className="w-full max-w-full h-auto object-cover rounded-lg bg-[#f5f5f5]"
					/>
				))}
			</div>
		</div>
