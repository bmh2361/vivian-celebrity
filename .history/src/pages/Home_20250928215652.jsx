		...
		<div className="">
			...
			<section className="max-w-7xl mx-auto px-6 pt-10 md:pt-14 pb-10 md:pb-16">
				<div className="grid md:grid-cols-2 gap-10 items-center">
					{/* 左侧文案 */}
					<div>
						<motion.div {...fadeUp(0)} className="inline-flex items-center gap-2 text-xs text-[#666] rounded-full border border-[#eee] px-3 py-1 bg-white">
							<span className="tracking-widest text-[#999]">VIVIAN CELEBRITY</span>
						</motion.div>
						...
						<motion.div {...fadeUp(0.2)} className="mt-3 text-[#666]">
							<div className="inline-flex flex-wrap items-center gap-2 text-sm">
								<span className="rounded-full bg-[#f6f6f6] text-[#444] px-3 py-1">英国高端美业</span>
								<span className="rounded-full bg-[#f6f6f6] text-[#444] px-3 py-1">影视 · 时尚 · 婚礼 · 旅拍 · 品牌合作</span>
							</div>
						</motion.div>
						<motion.div {...fadeUp(0.3)} className="mt-6 flex items-center gap-3">
							...
							<a href="/pages/portfolio.html" className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-medium text-[#111] border border-[#e8e8e8] bg-white hover:bg-[#fafafa] transition-colors">
								查看作品集
							</a>
						</motion.div>
					</div>
			...
			<section className="max-w-7xl mx-auto px-6 pb-16">
				<motion.div {...fade(0.05)} className="grid md:grid-cols-[1.1fr_1.4fr] gap-8 items-stretch border border-[#eee] rounded-3xl p-4 md:p-6 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
					...
					<div className="flex flex-col">
											...
											<motion.div {...fadeUp(0.12)} className="mt-1 text-xs md:text-sm tracking-widest text-[#9A7B4F]">发型总监 · VIVIAN CELEBRITY 创始人</motion.div>
											<motion.p {...fadeUp(0.16)} className="mt-3 text-sm leading-7 text-[#444]">
												资深造型与影像团队联合指导，深耕中英双语国际项目，擅长美学思维与妆造体系定制，
												将镜头与品牌气质转化为优雅质感并具辨识度的视觉表达。
											</motion.p>

						<motion.div {...fadeUp(0.18)} className="mt-5 grid sm:grid-cols-2 gap-4">
							{/* 核心服务 */}
							<div className="rounded-2xl border border-[#eee] bg-white p-4">
								<div className="text-[#111] font-semibold mb-2">核心服务</div>
							...
							{/* 服务领域 */}
							<div className="rounded-2xl border border-[#eee] bg-white p-4">
								<div className="text-[#111] font-semibold mb-2">服务领域</div>
								<ul className="text-sm text-[#555] space-y-1 list-disc list-inside">
									<li>电影/短片/综艺/广告</li>
									<li>时尚大片/妆造/海外旅拍</li>
									<li>明星品牌/婚礼跟妆</li>
