	...
	return (
		<div className="max-w-7xl mx-auto px-6 py-12">
			...
			<div className="mt-8 space-y-6">
				{members.map((m, i) => (
					<motion.div key={i} {...fade(i * 0.03)} className="grid md:grid-cols-2 gap-5 rounded-2xl border border-[#eee] bg-white p-4 md:p-5">
						<img src={m.photo} alt={m.name} className="w-full aspect-[3/4] object-cover rounded-xl" />
