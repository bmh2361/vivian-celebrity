...
export default function Home() {
	...
	return (
		<div className="">
			{/* Hero 改为整段背景：请在 public/ 目录放置 hero-bg-city.jpg */}
			<section className="relative overflow-hidden" style={{
				// 优先使用 hero-bg-city.jpg；若缺失，回退到 hero-company.jpg
				backgroundImage: `url(${withBase('/hero-bg-city.jpg')}), url(${withBase('/hero-company.jpg')})`,
				...
				<div className="absolute inset-0" style={{
					background: 'linear-gradient(180deg, rgba(255,255,255,0.65) 0%, rgba(255,255,255,0.55) 25%, rgba(210,225,245,0.45) 55%, rgba(200,220,240,0.55) 75%, rgba(190,215,235,0.65) 100%)'
				}} />
				{/* 叠加柔和蓝色薄层 + 金色下缘渐变 */}
				<div className="absolute inset-0" style={{
					background: 'linear-gradient(to bottom, rgba(170,200,230,0.35) 0%, rgba(170,200,230,0.15) 55%, rgba(207,175,107,0.18) 85%, rgba(207,175,107,0.25) 100%)',
					mixBlendMode: 'multiply'
				}} />
				<div className="max-w-7xl mx-auto px-6 pt-14 md:pt-20 pb-16 md:pb-24 relative">
					{/* 内容容器加半透明背景提升可读性 */}
					<div className="max-w-xl bg-white/65 backdrop-blur-sm rounded-2xl p-6 shadow-[0_8px_28px_-4px_rgba(0,0,0,0.15)] border border-white/60">
