		...
		<div className="">
			...
			<section className="relative overflow-hidden bg-white">
				<div className="max-w-7xl mx-auto px-6 pt-14 md:pt-20 pb-16 md:pb-24 relative">
					{/* 右上角图片卡片（md+ 显示） */}
					<motion.div initial={{ opacity: 0, y: -8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, ease: 'easeOut' }} className="hidden md:block absolute top-6 right-6">
						<div className="rounded-2xl overflow-hidden shadow-[0_12px_30px_rgba(0,0,0,0.12)] border border-[#eee] bg-white">
							<HeroImage withBase={withBase} />
						</div>
					</motion.div>
					{/* 内容容器加半透明背景提升可读性 */}
...
function HeroImage({ withBase }) {
	...
	return (
		<img
			src={src}
			alt="hero"
			className="w-[360px] lg:w-[420px] h-[240px] lg:h-[300px] object-cover"
